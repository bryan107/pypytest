...
public class CorrelationAsessment {
	...
	private	Map<Integer, Map<Integer, EstimatedVariancePCA>> Estimation;
	...
	public void setup(Map<Integer, Double> reading,
			Map<Integer, Map<Integer, EstimatedVariancePCA>> Estimation) {
		this.reading = reading;
		this.Estimation = Estimation;
	}

	public Map<Integer, Map<Integer, Boolean>> assessCorrelation(Map<Integer, Double> reading, Map<Integer, Map<Integer, EstimatedVariancePCA>> estimation) {
