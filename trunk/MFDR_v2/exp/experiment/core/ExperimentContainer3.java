...
//	private final int NoC = 4;
	...
	private final String writeaddress = "C:\\TEST\\MDFR\\Data\\Experiment\\RepresentationError3.csv";
	private final String listaddress = "C:\\TEST\\MDFR\\Data\\dataset\\Leftout.txt";
	...
	public void test(){
		...
		for(int i = 0 ; i < filenamelist.size() ; i++){
			...
			count ++;
			System.out.println("PROGRESS:"+ (count / 4 / filenamelist.size()));
