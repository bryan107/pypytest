...
public class SimulatorWithEWMA {

	public static void main(String[] args) {
		Log logger = LogFactory.getLog(SimulatorWithEWMA.class);
...
//		Map<Integer, GridSimulatorWithEWMA> demandermap = new HashMap<Integer, GridSimulatorWithEWMA>();
//		Map<Integer, GridSimulatorWithEWMA> suppliermap = new HashMap<Integer, GridSimulatorWithEWMA>();
		double count = 0;
		GridSimulatorWithEWMA grid;
		...
		for (double ratio = 0.00; ratio < 0.011; ratio += 0.001) {
			...
			for (int i = 0; i < demands.length; i++) {
				...
				grid = new GridSimulatorWithEWMA("C:\\TEST\\GRID\\TRANSMISSION\\DEMANDER_EWMA_V_0.15\\demander_G_"
			...
			for (int i = 0; i < supplys.length; i++) {
				...
				grid = new GridSimulatorWithEWMA("C:\\TEST\\GRID\\TRANSMISSION\\SUPPLIER_EWMA_V_0.15\\supplier_G_"
