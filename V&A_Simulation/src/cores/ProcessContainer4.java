...
public class ProcessContainer4 {

	private static Log logger = LogFactory.getLog(ProcessContainer4.class);
...
//			dp.run();
//		}
		for(double faultratio = 0.0000 ; faultratio < 0.01 ; faultratio *= 10){
			FaultSymptom fs = new NullFault();
