...
public class ErrorEeperiment extends TestCase {
	private final String[] writeaddress = { "C:\\TEST\\MDFR\\Data\\FacadeExample3.csv",
...
// **************** Test Cases ****************
	...
	public void testError(){
		test(3, 1, "C:\\TEST\\MDFR\\Data\\GOOD.csv");
//		for(int i = 1 ; i <4 ; i++ ){
...
//		File.getInstance().saveLinkedListToFile("Seasonal", seasonalfull, writeaddress[0]);
	...
	//	File.getInstance().saveLinkedListToFile("MFDR_N_E", mfdr_no_error, writeaddress[0]);
		System.out.println("d:" + ts1.energyDensity());
		System.out.println("PLA:" + pla_error.energyDensity());
		System.out.println("DFT:" + dft_error.energyDensity());
		System.out.println("PAA:" + paa_error.energyDensity());
		System.out.println("MFDR:" + mfdr_error.energyDensity());
		System.out.println("MFDR_NO:" + mfdr_no_error.energyDensity());
	}
}
