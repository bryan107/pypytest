...
//			DEMANDS
			for (int i = 0; i < demands.length; i++) {
				...
				grid = new GridSimulatorWithGAD("C:\\TEST\\GRID\\TRANSMISSION\\DEMANDER_GAD_V_0.15\\demander_G_"
			...
			for (int i = 0; i < supplys.length; i++) {
				...
				grid = new GridSimulatorWithGAD("C:\\TEST\\GRID\\TRANSMISSION\\SUPPLIER_GAD_V_0.15\\supplier_G_"
